...
Description: A Lightweight, Complete WordPress Contact Plugin with Customizable Labels, Email Setup, Placeholders, and Styling. Supports attachments, Custom CSS, and more—all from the dashboard.
Author: ahrana 
Version: 1.0
